...
# ADDINNAME is the displayed name of the add-in
#---------------------------------------------------------------------------------
...
MKG3AFLAGS := -n basic:Connections -i uns:../resource/unselected.bmp -i sel:../resource/selected.bmp
